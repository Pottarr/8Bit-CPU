...
\hline
\text{NOP Signal} &\ &\ \\
NOP & 00000\ |\ DC [4:0] & \text{No Operation} \\[2pt]
\hline
\end{array}
\]
}
...
\subsection{Pipeline Transitions Dive Through}

\textbf{IF/ID Transition Pipeline}

\begin{center}
\includegraphics[width=0.4\textwidth]{images/IF-ID.png} \\
\end{center}

\textbf{ID/EX Transition Pipeline}

\begin{center}
\includegraphics[width=0.4\textwidth]{images/ID-EX.png} \\
\end{center}

\textbf{EX/ME Transition Pipeline}

\begin{center}
\includegraphics[width=0.4\textwidth]{images/EX-ME.png} \\
\end{center}

\textbf{ME/WB Transition Pipeline}

\begin{center}
\includegraphics[width=0.4\textwidth]{images/ME-WB.png} \\
\end{center}

\subsection{Other Parts Dive Through}
