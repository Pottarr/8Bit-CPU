...
\subsection{Test 0: Overall Instructions}
\noindent \texttt{test0.ass}
\inputminted[fontsize=\scriptsize, breaklines, breakanywhere, breakindent=1em]{}{../test/test0.ass}

\newpage

\subsection{Test 1: Pipeline Hazard Check}
\noindent \texttt{test1.ass}
\inputminted[fontsize=\scriptsize, breaklines, breakanywhere, breakindent=1em]{}{../test/test1.ass}

\subsection{Test 2: Branching Check}
\noindent \texttt{test2.ass}
\inputminted[fontsize=\scriptsize, breaklines, breakanywhere, breakindent=1em]{}{../test/test2.ass}

\subsection{Test 3: Stack Warning Check}
